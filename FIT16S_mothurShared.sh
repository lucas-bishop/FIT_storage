...
mothur "#remove.groups(shared="${WORKDIR}"/final.shared, groups=water5-water6-water7-water8-mock5-mock6-mock7-mock8)"
...
mothur "#get.groups(shared="${WORKDIR}"/final.shared, groups=mock5-mock6-mock7-mock8)"
...
mothur "#get.groups(shared="${WORKDIR}"/final.shared, groups=water5-water6-water7-water8)"
